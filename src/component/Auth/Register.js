...
function Register(props){
    ...
    const navigate=useNavigate()    //navigate to other comp
    ...
    const submitHandler=async(event)=>{
        ...
        .then(res=>{
            let ref=Fireapp.databse().ref().child('users')
            const data={
                id:res.uid,
                name:reg.name,
                email:reg.user,
                        ...
                        <div className="card-body">
                            ...
                            <div className="form-group mt-2">
                                ...
                                <div className="form-group mt-2">
                                    ...
                                    <input type="email" name="user" id="user" className="form-control" required></input>
                                </div>
                                <div className="form-group mt-2">
                                    <label htmlfor="pass">Password</label>
                                    <input type="password" name="pass" id="pass" className="form-control" required></input>
                                </div>
                                <div className="form-group mt-2">
                                    <input type="submit" value="Register"  className="btn btn-warning" required></input>
                                </div>
                            </form>
                        </div>
                    </div>
